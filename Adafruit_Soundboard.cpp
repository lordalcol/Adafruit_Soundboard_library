...
/*!
 * @brief Anything printed to Soundboard object will be split to both the sound
 * card and debug streams.  Saves having to print everything twice in debug
 * code.
 */
